 ...
 * Create a Worker.
 */
async function createWorker({ logLevel = 'error', logTags, rtcMinPort = 10000, rtcMaxPort = 59999, plainMinPort = 0, plainMaxPort = 0, dtlsCertificateFile, dtlsPrivateKeyFile, appData = {} } = {}) {
